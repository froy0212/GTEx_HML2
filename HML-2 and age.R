...
write.csv(big_data_tissue_final,paste(Demographics,"age_range_distribution_for_HML2_expression_differences_08142020.csv",sep="/"))
...
ggsave(path = age, file ="Differences in HML-2 expression in regards to age in GTEx.png")
